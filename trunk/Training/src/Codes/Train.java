...
/**
 * Train class which runs the stock market prediction sample - creates and trains neural network for stock prediction.
...
public class Train {
    ...
    public static String getoutput(){
        String tmpString = output.replace("[","");
        String output = tmpString.replace("]","");
        return output;
    ...
    public static void main() {
        ...
        testSet.addRow(new DataSetRow(new double[]{3625.0D / daxmax, 4259.0D / daxmax, 4203.0D / daxmax, 3345.0D / daxmax}, new double[]{0000.0D / daxmax}));
